...
BicDB ${report.bicdb_version} targets PostgreSQL ${report.target.postgres_version} type behavior. This
...
This is the declared client surface for BicDB ${report.bicdb_version} against PostgreSQL
${report.target.postgres_version}. \`cross_target\` entries run the same assertions against BicDB and
