...
Current source version: **BicDB 1.0.438-beta**. BicDB targets PostgreSQL
18.4 type behavior within the tested compatibility surface; it is not a
complete PostgreSQL implementation.

## Retained evidence

The matrix below was recorded for **BicDB 1.0.140-beta**. Its original
